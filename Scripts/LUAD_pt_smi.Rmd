...
DimPlot(LCO, reduction = "umap", label = TRUE)
ImageDimPlot(LCO, dark.background = F, border.color = "black", axes=T)
...
Idents(LCO) <- LCO$seurat_clusters
DotPlot(LCO, features = c("MHC I","SERPINA1", "S100A2", "ITGA3","SAT1", "KRT7","KRT8", "KRT18","KRT19", "S100A6",  #Adenocarcinoma
                          "TPSAB1/B2", "CPA3", "KIT", "IL1RL1",#mast cell
                          "NEAT1", "MALAT1","CCL21","CD3D","CD3E","CD3G", "CD4","CD8A","CD8B","CD69","CD44","CXCR4", #T cells
                          "CD19", "CD79A", "IGHG1", "IGHG2","IGKC", "IGHA1", # Bcells
                          ...
                          "COL1A1", "COL3A1", "COL1A2", "COL6A3", " COL5A1", "MMP2", "BGN", #Fibro1
                          "LUM", "RPL21","RPL37", "MGP", "RACK1", "TIMP1" )) #fibro2

DotPlot(LCO, features = c("SERPINA1", "S100A2", "ITGA3","SAT1", "KRT7","KRT8", "KRT18","KRT19", "S100A6",  #Adenocarcinoma
                          "TPSAB1/B2", "CPA3", "KIT", "IL1RL1",#mast cell
...
markers.1 <- FindMarkers(LCO, ident.1 = "1")
markers.2 <- FindMarkers(LCO, ident.1 = "2")

## SUBSET 
LCO1 <- subset(x = LCO, idents = c("1", "2"), invert = TRUE)
...
ratio_fibro <- 2857/1353
ratio_endo <- 1738/1353
